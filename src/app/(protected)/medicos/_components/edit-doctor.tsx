...
const EditDoctor = ({ item }: { item: AddMedicFormData & { id: string } }) => {
    ...
    return (
        <Dialog>
            <DialogTrigger asChild><Button className='cursor-pointer'>Editar informações</Button></DialogTrigger>
            <DialogContent>
                ...
                <Form {...form}>
                    <form onSubmit={form.handleSubmit(onSubmit, onError)}>
                        ...
                        <Button className='cursor-pointer w-full mt-2'>Alterar informações</Button>
                    </form>
                </Form>
            </DialogContent>
        </Dialog >
